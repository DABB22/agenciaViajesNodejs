...
(1, 'Diego', 'dcorreo@correo.com', 'Todo muy hermoso');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(2, 'karen', 'kcorreo@correo.com', 'Me encantó');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(3, 'Vanessa', 'vcorreo@correo.com', 'Todo lo que hay para hacer es muy interesante, excelente atención');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(4, 'Estella', 'ecorreo@correo.com', 'Muy hermoso el paisaje, la naturaleza, los sitios aledaños, vale la pena ir y disfrutarlo.');
